// --------------------------------------------------------------------------------------------------------------------
// <copyright file="StringExtensions.cs" company="Zaust">
...
namespace Summit.Core.Extensions
{
    ...
    internal static class StringExtensions
    {
        ...
        public static bool IsMatch(
            this string input, string pattern, RegexOptions options = RegexOptions.IgnoreCase | RegexOptions.Multiline)
        {
        ...
        public static string RegexMatchOne(
            this string input, string pattern, RegexOptions options = RegexOptions.IgnoreCase | RegexOptions.Multiline)
        {
        ...
        public static bool MatchAnyWord(this string input, params string[] patterns)
        {
            return
                patterns.Any(
                    pattern => Regex.IsMatch(input, String.Format(@"\b{0}\b", pattern), RegexOptions.IgnoreCase));
        }
        ...
        public static string Join(this IEnumerable<string> strList, string joinStr)
        {
            ...
            {
                if (result.Length == 0) result.Append(joinStr);
                result.Append(str);
            }
